# WMS365 Billing & Finance: Zoho Books Replacement Checklist
...
- [x] Run Billing & Finance schema initialization against the production Postgres database with `DATABASE_URL` configured.
...
- [x] Keep Billing & Finance as a separate WMS365 module from the legacy Billing Ledger.
- [x] Restrict Billing & Finance to Super Admin, Admin, Accounting, and Finance Manager roles.
...
- [~] Add printable invoice output.
- [ ] Replace printable invoice output with durable PDF generation.
